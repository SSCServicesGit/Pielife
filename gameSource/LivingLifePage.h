...
class LivingLifePage : public GamePage, public ActionListener {
    ...
    public:
        ...
        void hetuwDrawHUDWithHandwritingFont( const char *inString, doublePair inPos );
        int hetuwGetMapD();                    // returns mMapD
        int hetuwGetBiomeFromMapIndex(int mapI); // returns mMapBiomes[mapI] or -1
        int hetuwGetMapOffsetX();
        int hetuwGetMapOffsetY();
