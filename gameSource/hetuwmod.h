...
public:
	...
	static unsigned char charKey_OpenAllDoors;
	...
	static void Say(const char *text, int cipherNum = 0);
	...
	static void drawHostilePlayers(LiveObject* player);
	//Chars
...
private:
	...
	static void drawCravings();
	static void drawYumFacts();
	static void drawAge();
	...
	static void drawCraving();
	static void drawBonusHunger();
