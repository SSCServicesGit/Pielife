...
ExistingAccountPage::ExistingAccountPage()
        : mEmailField( mainFont, 0, 128, 10, false, 
          ...
          mSSCComButton( mainFont, 450, -240, "SSC Services" ),
    ...
    mSSCComButton.addActionListener( this );
...
void ExistingAccountPage::makeActive( char inFresh ) {
    ...
    mSSCComButton.setVisible( false );    
...
void ExistingAccountPage::actionPerformed( GUIComponent *inTarget ) {
    ...
    else if( inTarget == &mSSCComButton ) {     
        const char *discordURL = "https://discord.gg/Kq9ATWAYAX";
        char *urlCopy = stringDuplicate( discordURL );
        launchURL( urlCopy );
        delete [] urlCopy;
    }
